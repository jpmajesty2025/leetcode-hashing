...
from intersection_of_multiple_arrays import intersection_multiple_arrays
...
def test_intersection_multiple_arrays_examples(nums, expected):
...
def test_intersection_multiple_arrays_matches_reference(nums):
